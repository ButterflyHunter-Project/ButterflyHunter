...
public class Main extends Activity {//AR is an activity. AR includes two Surfaceview objects:CameraView and ARView. Basically an activity means a screen
	...
	public static String information = "HaHaHa!";
