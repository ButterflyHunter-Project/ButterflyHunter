...
public class Calculator {
	private static double upperThreshold=1.1;//if the new size of the image exceeds the upperThreshold, update the image.
	private static double lowerThreshold=0.9;
	private static double xMoveThreshold=0;//if the position change of the butterfly exceeds this threshold, reDraw the butterfly
